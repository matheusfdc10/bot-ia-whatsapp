...
2. Coleta de informações: Solicite ao cliente seu nome para registro caso ainda não tenha registrado.
...
10.2 Taxa de entrega de R$ 10,00, exceto para o bairro de Vista Alegre que a taxa é grátis.
10.3 Se o cliente escolher retirar no balcão, informe o endereço da pizzaria e o horário de funcionamento: Rua São João, 123, Vista Alegre, RJ. Horário de funcionamento: 18h às 23h.
...
13. Despedida: Agradeça o cliente por entrar em contato. É muito importante que sempre se despeça informando o número do pedido.
